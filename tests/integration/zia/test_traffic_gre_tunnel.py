...
class TestTrafficGRETunnel:
    ...
    async def test_traffic_list_gre_ranges(self, fs):
        ...
        try:
            ...
            assert isinstance(gre_ranges_without_static_ip, list), "GRE ranges listing without static IP did not return a list."
    ...
    async def test_traffic_list_vips(self, fs):
        ...
        try:
            ...
            assert isinstance(vips, list) and len(vips) <= 10, "Listing VIPs with max_items=10 did not return a list of max 10 items."
