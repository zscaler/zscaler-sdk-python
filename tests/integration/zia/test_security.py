...
class TestSecurityWhitelistBlacklist:
    ...
    def test_security_policy_whitelist_blacklist_workflow(self, fs):
        ...
        try:
            ...
            try:
                result = client.zia.security_policy_settings.add_urls_to_whitelist(whitelist_urls)
            ...
            try:
                result = client.zia.security_policy_settings.get_whitelist()
            ...
            try:
                result = client.zia.security_policy_settings.replace_whitelist(new_whitelist_urls)
            ...
            try:
                result = client.zia.security_policy_settings.delete_urls_from_whitelist(new_whitelist_urls)
            ...
            try:
                result = client.zia.security_policy_settings.add_urls_to_blacklist(blacklist_urls)
            ...
            try:
                result = client.zia.security_policy_settings.get_blacklist()
            ...
            try:
                result = client.zia.security_policy_settings.replace_blacklist(new_blacklist_urls)
            ...
            try:
                _ = client.zia.security_policy_settings.erase_whitelist()
            except Exception as exc:
                errors.append(f"Whitelist cleanup failed: {exc}")

            try:
                _ = client.zia.security_policy_settings.erase_blacklist()
            except Exception as exc:
