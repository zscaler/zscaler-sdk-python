...
class TestSecurityWhitelistBlacklist:
    ...
    def test_add_url_to_whitelist(self, fs):
        ...
        try:
            updated_whitelist = client.zia.security_policy_settings.add_urls_to_whitelist([url_to_add])
    ...
    def test_get_whitelist(self, fs):
        client = MockZIAClient(fs)
        try:
            whitelist = client.zia.security_policy_settings.get_whitelist()
    ...
    def test_replace_url_from_whitelist(self, fs):
        ...
        try:
            updated_whitelist = client.zia.security_policy_settings.replace_whitelist(url_to_replace)
    ...
    def test_delete_urls_from_whitelist(self, fs):
        ...
        try:
            updated_whitelist = client.zia.security_policy_settings.delete_urls_from_whitelist([url_to_delete])
    ...
    def test_add_urls_to_blacklist(self, fs):
        ...
        try:
            updated_blacklist = client.zia.security_policy_settings.add_urls_to_blacklist([url_to_add])
    ...
    def test_replace_blacklist(self, fs):
        ...
        try:
            updated_blacklist = client.zia.security_policy_settings.replace_blacklist(new_blacklist_urls)
    ...
    def test_erase_blacklist(self, fs):
        client = MockZIAClient(fs)
        try:
            result = client.zia.security_policy_settings.erase_blacklist()
