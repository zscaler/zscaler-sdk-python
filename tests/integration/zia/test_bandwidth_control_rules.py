    ...
    def test_bandwidth_control_rules(self, fs):
        ...
        try:
            ...
            try:
                ...
                created_bdw_class = client.zia.bandwidth_classes.add_class(
                    name=bdw_class_name,
            ...
            try:
                ...
                created_rule = client.zia.bandwidth_control_rules.add_rule(
                    name=rule_name,
            ...
            try:
                retrieved_rule = client.zia.bandwidth_control_rules.get_rule(rule_id)
            ...
            try:
                ...
                updated_rule = client.zia.bandwidth_control_rules.update_rule(
                    rule_id=rule_id,
                    name=rule_name,
            ...
            try:
                rules = client.zia.bandwidth_control_rules.list_rules()
            ...
            if rule_id:
                try:
                    _ = client.zia.bandwidth_control_rules.delete_rule(rule_id)
                except Exception as exc:
            ...
            if class_id:
                try:
                    _ = client.zia.bandwidth_classes.delete_class(class_id)
                except Exception as exc:
