    ...
    def test_cloud_firewall_network_services_group(self, fs):
        ...
        try:
            for service_name in ["ICMP_ANY", "UDP_ANY", "TCP_ANY", "DNS"]:
                services = client.zia.cloud_firewall.list_network_services(query_params={"search": service_name})
        ...
        try:
            created_group = client.zia.cloud_firewall.add_network_svc_group(
                name=group_name,
        ...
        try:
            if group_id:
                group = client.zia.cloud_firewall.get_network_svc_group(group_id)
        ...
        try:
            if group_id:
                ...
                updated_group = client.zia.cloud_firewall.update_network_svc_group(
                    group_id=group_id,
                    name=updated_name,
        ...
        try:
            groups = client.zia.cloud_firewall.list_network_svc_groups()
            ...
            try:
                if group_id:
                    _ = client.zia.cloud_firewall.delete_network_svc_group(group_id)
