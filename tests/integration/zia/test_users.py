...
class TestUsers:
    ...
    async def test_users(self, fs):
        ...
        time.sleep(1)  # Add a sleep before fetching the user
        ...
        time.sleep(1)  # Add a sleep before listing users
        ...
        try:
            ...
            time.sleep(1)  # Add a sleep before finally deleting the user
            ...
            if user_id:
                try:
                    ...
                    time.sleep(1)  # Add a sleep before activation
