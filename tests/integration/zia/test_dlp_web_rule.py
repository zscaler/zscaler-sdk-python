...
class TestDLPWebRule:
    ...
    def test_dlp_web_rule(self, fs):
        ...
        try:
            ...
            created_rule = client.zia.dlp_web_rules.add_rule(
                name=rule_name,
        ...
        try:
            retrieved_rule = client.zia.dlp_web_rules.get_rule(rule_id)
            ...
            try:
                ...
                updated_rule = client.zia.dlp_web_rules.update_rule(
                    rule_id=rule_id,
                    name=rule_name,
            ...
            try:
                rules = client.zia.dlp_web_rules.list_rules()
            ...
            try:
                if rule_id:
                    ...
                    _ = client.zia.dlp_web_rules.delete_rule(rule_id)
            except Exception as exc:
