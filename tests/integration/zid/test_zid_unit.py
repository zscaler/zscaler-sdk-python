...
class TestGroupsUnit:
    """
    Unit tests for the Z Id groups API to increase coverage
    """
...
class TestUsersUnit:
    """
    Unit tests for the Z Id users API to increase coverage
    """
...
class TestUserEntitlementUnit:
    """
    Unit tests for the Z Id user entitlement API to increase coverage
    """
...
class TestResourceServersUnit:
    """
    Unit tests for the Z Id resource servers API to increase coverage
    """
...
class TestZIdServiceUnit:
    """
    Unit tests for the Z Id service to increase coverage
    """
    ...
    def test_zid_service_properties(self, fs):
        ...
        service = ZIdService(mock_executor)
