...
class TestFirewall:
    ...
    @pytest.mark.vcr()
    def test_get_traffic_by_action(self, fs, zins_client):
        client = zins_client
        start_time, end_time = get_time_range(7)

        entries, response, err = client.zins.firewall.get_traffic_by_action(start_time=start_time, end_time=end_time, limit=10)
    ...
    @pytest.mark.vcr()
    def test_get_network_services(self, fs, zins_client):
        client = zins_client
        start_time, end_time = get_time_range(7)

        entries, response, err = client.zins.firewall.get_network_services(start_time=start_time, end_time=end_time, limit=10)
