...
class TestWebTraffic:
    """
    Integration Tests for the Z-Insights Web Traffic Analytics
    """

    @pytest.mark.vcr()
    def test_get_traffic_by_location(self, fs, zins_client):
        client = zins_client
    ...
    @pytest.mark.vcr()
    def test_get_traffic_by_location_with_trend(self, fs, zins_client):
        client = zins_client
        start_time, end_time = get_time_range(7)
    ...
    @pytest.mark.vcr()
    def test_get_no_grouping(self, fs, zins_client):
        client = zins_client
        start_time, end_time = get_time_range(7)

        entries, response, err = client.zins.web_traffic.get_no_grouping(
            start_time=start_time, end_time=end_time, traffic_unit="TRANSACTIONS", limit=10
        )
    ...
    @pytest.mark.vcr()
    def test_get_protocols(self, fs, zins_client):
        client = zins_client
        start_time, end_time = get_time_range(7)
    ...
    @pytest.mark.vcr()
    def test_get_threat_super_categories(self, fs, zins_client):
        client = zins_client
        start_time, end_time = get_time_range(7)
    ...
    @pytest.mark.vcr()
    def test_get_threat_class(self, fs, zins_client):
        client = zins_client
        start_time, end_time = get_time_range(7)
