...
class TestAccessPrivilegedConsoleV2:
    ...
    def test_access_privileged_console_v2(self, fs):
        ...
        try:
            ...
            try:
                app_segments = client.zpa.app_segment_by_type.get_segments_by_type(
            ...
            try:
                ...
                created_console = client.zpa.pra_console.add_console(
                    name="tests-pracon-" + generate_random_string(),
                    description="tests-pracon-" + generate_random_string(),
                    enabled=True,
            ...
            try:
                ...
                all_consoles = client.zpa.pra_console.list_consoles()
            ...
            try:
                ...
                retrieved_console = client.zpa.pra_console.get_console(console_id)
            ...
            try:
                ...
                _ = client.zpa.pra_console.update_console(
                ...
                print(f"PRA Console with ID {console_id} updated successfully.")
            except Exception as exc:
            ...
            if console_id:
                try:
                    delete_response = client.zpa.pra_console.delete_console(console_id=console_id)
            ...
            if portal_id:
                try:
                    delete_response = client.zpa.pra_portal.delete_portal(portal_id=portal_id)
                    assert delete_response is None, f"Expected None for 204 No Content, got {delete_response}"
                except Exception as exc:
            ...
            if credential_id:
                try:
                    delete_response = client.zpa.pra_credential.delete_credential(credential_id=credential_id)
                    assert delete_response is None, f"Expected None for 204 No Content, got {delete_response}"
                except Exception as exc:
            ...
            if app_segment_id:
                try:
                    delete_response = client.zpa.app_segments_pra.delete_segment_pra(
            ...
            if app_connector_group_id:
                try:
                    delete_response = client.zpa.app_connector_groups.delete_connector_group(
