...
class TestCBIBanners:
    ...
    def test_cbi_banner(self, fs):
        ...
        try:
            ...
            created_banner = client.zpa.cbi_banner.add_cbi_banner(
                name=banner_name,
        ...
        try:
            if banner_id:
                ...
                retrieved_banner = client.zpa.cbi_banner.get_cbi_banner(banner_id)
                ...
                updated_banner = client.zpa.cbi_banner.update_cbi_banner(
                    banner_id,
                    name=updated_name,
                    primary_color="#0076BE",
                    text_color="#FFFFFF",
            ...
            if banner_id:
                try:
                    ...
                    delete_response = client.zpa.cbi_banner.delete_cbi_banner(banner_id)
