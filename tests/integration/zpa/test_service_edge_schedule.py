...
#             schedule = client.zpa.service_edge_schedule.get_service_edge_schedule()
...
#             new_schedule = client.zpa.service_edge_schedule.add_service_edge_schedule(
#                 frequency="days",
#                 interval="5",
#                 disabled=False,
#                 enabled=True,
...
#             updated_schedule = client.zpa.service_edge_schedule.update_service_edge_schedule(
