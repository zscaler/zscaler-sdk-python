...
class TestAccessPolicyIsolationRuleV1:
    ...
    def test_access_policy_isolation_rules_v1(self, fs):
        ...
        try:
            ...
            try:
                rule_name = "tests-apir1-" + generate_random_string()
            ...
            try:
                ...
                _ = client.zpa.policies.update_isolation_rule(
                    rule_id=rule_id,
                    name=rule_name,
            ...
            try:
                rules = client.zpa.policies.list_rules("isolation")
            ...
            if rule_id:
                try:
                    _ = client.zpa.policies.delete_rule("isolation", rule_id)
                except Exception as exc:
