...
class TestSweepUtility:
    ...
    def sweep_all_access_policies(self):
        ...
        try:
            for policy_type in policy_types:
                ...
                policies = self.client.zpa.policies.list_rules(policy_type=policy_type)
                ...
                for policy in test_policies:
                    ...
                    _ = self.client.zpa.policies.delete_rule(policy_type=policy_type, rule_id=policy.id)
    ...
    def sweep_pra_portal(self):
        ...
        try:
            portals = self.client.zpa.pra_portal.list_portals()
            ...
            for portal in test_portals:
                ...
                _ = self.client.zpa.pra_portal.delete_portal(portal_id=portal.id)
    ...
    def sweep_pra_credential(self):
        ...
        try:
            portals = self.client.zpa.pra_credential.list_credentials()
            test_portals = [pra for pra in portals if hasattr(pra, "name") and pra.name.startswith("tests-")]
            ...
            for credential in test_portals:
                ...
                _ = self.client.zpa.pra_credential.delete_credential(credential_id=credential.id)
    ...
    def sweep_pra_approval(self):
        ...
        try:
            portals = self.client.zpa.pra_approval.list_approval()
            test_approvals = [
            ...
            for approval in test_approvals:
                ...
                _ = self.client.zpa.pra_approval.delete_approval(approval_id=approval.id)
    ...
    def sweep_pra_console(self):
        ...
        try:
            portals = self.client.zpa.pra_console.list_consoles()
            test_portals = [pra for pra in portals if hasattr(pra, "name") and pra.name.startswith("tests-")]
            ...
            for console in test_portals:
                ...
                _ = self.client.zpa.pra_console.delete_console(console_id=console.id)
    ...
    def sweep_microtenant(self):
        ...
        try:
            microtenants = self.client.zpa.microtenants.list_microtenants()
            ...
            for microtenant in test_microtenants:
                ...
                _ = self.client.zpa.microtenants.delete_microtenant(console_id=microtenant.id)
    ...
    def sweep_app_segments(self):
        ...
        try:
            app_segments = self.client.zpa.application_segment.list_segments()
            ...
            for segment in test_segments:
                ...
                _ = self.client.zpa.application_segment.delete_segment(segment_id=segment.id)
    ...
    def sweep_segment_group(self):
        ...
        try:
            segment_groups = self.client.zpa.segment_groups.list_groups()
            ...
            for group in test_groups:
                ...
                _ = self.client.zpa.segment_groups.delete_group(group_id=group.id)
    ...
    def sweep_server_group(self):
        ...
        try:
            server_groups = self.client.zpa.server_groups.list_groups()
            ...
            for group in test_groups:
                ...
                _ = self.client.zpa.server_groups.delete_group(group_id=group.id)
    ...
    def sweep_provisioning_key(self):
        ...
        try:
            for key_type in key_types:
                ...
                provisioning_keys = self.client.zpa.provisioning.list_provisioning_keys(key_type=key_type)
                ...
                for provisioning_key in test_provisioning_keys:
                    ...
                    _ = self.client.zpa.provisioning.delete_provisioning_key(
    ...
    def sweep_lss_controller(self):
        ...
        try:
            list_controllers = self.client.zpa.lss.list_configs()
            ...
            for controller in test_controllers:
                ...
                _ = self.client.zpa.lss.delete_lss_config(lss_config_id=controller.id)
    ...
    def sweep_app_connector_group(self):
        ...
        try:
            app_connectors = self.client.zpa.app_connector_groups.list_connector_groups()
            ...
            for group in test_groups:
                ...
                _ = self.client.zpa.app_connector_groups.delete_connector_group(group_id=group.id)
    ...
    def sweep_application_server(self):
        ...
        try:
            app_servers = self.client.zpa.servers.list_servers()
            ...
            for server in test_servers:
                ...
                _ = self.client.zpa.servers.delete_server(server_id=server.id)
    ...
    def sweep_isolation_banner(self):
        ...
        try:
            banners = self.client.zpa.cbi_banner.list_cbi_banners()
            ...
            for banner in test_banners:
                ...
                _ = self.client.zpa.cbi_banner.delete_cbi_banner(banner_id=banner.id)
    ...
    def sweep_isolation_profile(self):
        ...
        try:
            profiles = self.client.zpa.cbi_profile.list_cbi_profiles()
            ...
            for profile in test_profiles:
                ...
                _ = self.client.zpa.cbi_profile.delete_cbi_profile(profile_id=profile.id)
    ...
    def sweep_isolation_certificate(self):
        ...
        try:
            certificates = self.client.zpa.cbi_certificate.list_cbi_certificates()
            ...
            for certificate in test_certificates:
                ...
                _ = self.client.zpa.cbi_certificate.delete_cbi_certificate(certificate_id=certificate.id)
    ...
    def sweep_service_edge_group(self):
        ...
        try:
            service_edge_grps = self.client.zpa.service_edge_group.list_service_edge_groups()
            ...
            for group in test_groups:
                ...
                _ = self.client.zpa.service_edge_group.delete_service_edge_group(group_id=group.id)
    ...
    def sweep_user_portal(self):
        ...
        try:
            user_portals = self.client.zpa.user_portal_controller.list_user_portals()
            ...
            for portal in test_portals:
                ...
                _ = self.client.zpa.user_portal_controller.delete_user_portal(portal_id=portal.id)
    ...
    def sweep_user_portal(self):
        logging.info("Starting to sweep service user portal")
        try:
            user_portals = self.client.zpa.user_portal_link.list_portal_link()
            test_portals = [portal for portal in user_portals if hasattr(portal, "name") and portal.name.startswith("tests-")]
            logging.info(f"Found {len(test_portals)} user portals to delete.")
            ...
            for portal in test_portals:
                ...
                _ = self.client.zpa.user_portal_link.delete_portal_link(portal_link_id=portal.id)
                logging.info(f"Successfully deleted portal ID={portal.id}")
    ...
    def sweep_private_cloud_group(self):
        ...
        try:
            groups = self.client.zpa.private_cloud_group.list_cloud_groups()
            ...
            for group in test_groups:
                ...
                _ = self.client.zpa.private_cloud_group.delete_cloud_group(group_id=group.id)
