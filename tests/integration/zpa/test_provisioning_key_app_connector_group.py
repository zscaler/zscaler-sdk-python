    ...
    def test_connector_group_provisioning_key(self, fs):
        ...
        try:
            ...
            try:
                ...
                connector_certs = client.zpa.enrollment_certificates.list_enrolment(
            ...
            try:
                ...
                created_connector_key = client.zpa.provisioning.add_provisioning_key(
                    key_type=key_type,
            ...
            try:
                ...
                all_connector_keys = client.zpa.provisioning.list_provisioning_keys(key_type)
            ...
            try:
                ...
                retrieved_connector_key = client.zpa.provisioning.get_provisioning_key(connector_key_id, key_type)
                assert (
            ...
            try:
                ...
                _ = client.zpa.provisioning.update_provisioning_key(connector_key_id, key_type, name=updated_name)
            except Exception as exc:
            ...
            if connector_key_id:
                try:
                    delete_response = client.zpa.provisioning.delete_provisioning_key(connector_key_id, key_type)
            ...
            if connector_group_id:
                try:
                    _ = client.zpa.app_connector_groups.delete_connector_group(connector_group_id)
                except Exception as exc:
