...
class TestWebTraffic:
    ...
    @pytest.mark.vcr()
    def test_get_traffic_by_location_with_trend(self, fs, zinsights_client):
        client = zinsights_client
        start_time, end_time = get_time_range(7)
    ...
    @pytest.mark.vcr()
    def test_get_no_grouping(self, fs, zinsights_client):
        client = zinsights_client
        start_time, end_time = get_time_range(7)
    ...
    @pytest.mark.vcr()
    def test_get_protocols(self, fs, zinsights_client):
        client = zinsights_client
        start_time, end_time = get_time_range(7)
    ...
    @pytest.mark.vcr()
    def test_get_threat_super_categories(self, fs, zinsights_client):
        client = zinsights_client
        start_time, end_time = get_time_range(7)
    ...
    @pytest.mark.vcr()
    def test_get_threat_class(self, fs, zinsights_client):
        client = zinsights_client
        start_time, end_time = get_time_range(7)
