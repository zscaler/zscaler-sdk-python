...
class TestPolicyDetection:
    ...
    def test_resolve_and_execute_policy_inbound(self, zguard_client):
        ...
        with zguard_client as client:
            result, response, error = client.zguard.policy_detection.resolve_and_execute_policy(
                content="What is the capital of France?", direction="IN"
            )
    ...
    def test_resolve_and_execute_policy_outbound(self, zguard_client):
        ...
        with zguard_client as client:
            result, response, error = client.zguard.policy_detection.resolve_and_execute_policy(
                content="The capital of France is Paris.", direction="OUT"
            )
    ...
    def test_execute_policy_without_policy_id(self, zguard_client):
        ...
        with zguard_client as client:
            result, response, error = client.zguard.policy_detection.execute_policy(
                content="Test content for policy execution", direction="IN"
            )
    ...
    def test_execute_policy_with_policy_id(self, zguard_client):
        ...
        with zguard_client as client:
            ...
            result, response, error = client.zguard.policy_detection.execute_policy(
                content="Test content with specific policy", direction="IN", policy_id=test_policy_id
            )
            ...
            if error:
                ...
                assert (
                    "403" in str(error) or "404" in str(error) or "401" in str(error)
    ...
    def test_response_structure(self, zguard_client):
        ...
        with zguard_client as client:
            result, response, error = client.zguard.policy_detection.resolve_and_execute_policy(
                content="Test response structure", direction="IN"
            )
    ...
    def test_detector_responses_structure(self, zguard_client):
        ...
        with zguard_client as client:
            result, response, error = client.zguard.policy_detection.resolve_and_execute_policy(
                content="Test detector responses", direction="IN"
            )
            ...
            assert isinstance(
                result.detector_responses, dict
            ...
            for detector_name, detector_response in result.detector_responses.items():
                assert hasattr(detector_response, "triggered"), f"Detector {detector_name} missing 'triggered' field"
                assert hasattr(detector_response, "action"), f"Detector {detector_name} missing 'action' field"
                assert hasattr(detector_response, "severity"), f"Detector {detector_name} missing 'severity' field"
    ...
    def test_throttling_details_structure(self, zguard_client):
        ...
        with zguard_client as client:
            result, response, error = client.zguard.policy_detection.resolve_and_execute_policy(
                content="Test throttling details", direction="IN"
            )
            ...
            assert isinstance(
                result.throttling_details, list
            ...
            for throttle in result.throttling_details:
                ...
                assert throttle.metric in ["rq", "cs", None], f"Invalid metric value: {throttle.metric}"
    ...
    def test_inbound_and_outbound_directions(self, zguard_client):
        ...
        with zguard_client as client:
            ...
            result_in, response_in, error_in = client.zguard.policy_detection.resolve_and_execute_policy(
                content="What is machine learning?", direction="IN"
            )
            ...
            result_out, response_out, error_out = client.zguard.policy_detection.resolve_and_execute_policy(
                content="Machine learning is a subset of artificial intelligence.", direction="OUT"
            )
    ...
    def test_empty_content(self, zguard_client):
        ...
        """
        with zguard_client as client:
            result, response, error = client.zguard.policy_detection.resolve_and_execute_policy(content="", direction="IN")
            ...
            if error:
                ...
                assert "400" in str(error) or "422" in str(error), f"Expected validation error for empty content, got: {error}"
            else:
    ...
    def test_large_content(self, zguard_client):
        ...
        with zguard_client as client:
            ...
            result, response, error = client.zguard.policy_detection.resolve_and_execute_policy(
                content=large_content, direction="IN"
            )

            if error:
                # May get content size error or throttling
                assert (
                    "400" in str(error) or "413" in str(error) or "429" in str(error)
    ...
    def test_action_values(self, zguard_client):
        ...
        with zguard_client as client:
            result, response, error = client.zguard.policy_detection.resolve_and_execute_policy(
                content="Test action values", direction="IN"
            )
            ...
            assert result.action in valid_actions, f"Invalid action value: {result.action}. Expected one of {valid_actions}"
    ...
    def test_severity_values(self, zguard_client):
        ...
        with zguard_client as client:
            result, response, error = client.zguard.policy_detection.resolve_and_execute_policy(
                content="Test severity values", direction="IN"
            )
    ...
    def test_policy_metadata_in_response(self, zguard_client):
        ...
        with zguard_client as client:
            result, response, error = client.zguard.policy_detection.resolve_and_execute_policy(
                content="Test policy metadata", direction="IN"
            )
    ...
    def test_rate_limit_stats(self, zguard_client):
        ...
        with zguard_client as client:
            ...
            # Make a request
            result, response, error = client.zguard.policy_detection.resolve_and_execute_policy(
                content="Test rate limit stats", direction="IN"
            )
            ...
            if result and result.throttling_details and len(result.throttling_details) > 0:
                assert (
                    after_stats["total_throttles"] > initial_stats["total_throttles"]
    ...
    def test_invalid_direction(self, zguard_client):
        ...
        with zguard_client as client:
            result, response, error = client.zguard.policy_detection.resolve_and_execute_policy(
                content="Test invalid direction", direction="INVALID"
            )
            ...
            if error is not None:
                ...
                assert "400" in str(error) or "422" in str(error), f"Expected validation error, got: {error}"
            else:
    ...
    def test_special_characters_in_content(self, zguard_client):
        ...
        with zguard_client as client:
            ...
            result, response, error = client.zguard.policy_detection.resolve_and_execute_policy(
                content=special_content, direction="IN"
            )
    ...
    def test_numeric_and_code_content(self, zguard_client):
        ...
        with zguard_client as client:
            ...
            result, response, error = client.zguard.policy_detection.resolve_and_execute_policy(
                content=code_content, direction="OUT"
            )
    ...
    def test_client_context_manager(self, zguard_client):
        ...
        with zguard_client as client:
            ...
            result, response, error = client.zguard.policy_detection.resolve_and_execute_policy(
                content="Test context manager", direction="IN"
            )
    ...
    def test_transaction_id_format(self, zguard_client):
        ...
        with zguard_client as client:
            result, response, error = client.zguard.policy_detection.resolve_and_execute_policy(
                content="Test transaction ID format", direction="IN"
            )
