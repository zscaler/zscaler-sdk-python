...
def test_request_executor_initialization_with_legacy_clients():
    ...
    executor = RequestExecutor(config, cache, zpa_legacy_client=mock_zpa, zia_legacy_client=mock_zia)
...
def test_request_executor_initialization_with_invalid_timeout():
    ...
    config = {"client": {"requestTimeout": -1, "rateLimit": {"maxRetries": 2}}}
...
def test_request_executor_initialization_with_invalid_retries():
    ...
    config = {"client": {"requestTimeout": 240, "rateLimit": {"maxRetries": -1}}}
...
def test_request_executor_initialization_with_missing_rate_limit():
    ...
    config = {"client": {"requestTimeout": 240}}
...
def test_get_retry_after_with_max_retry_seconds():
    ...
    config = {"client": {"rateLimit": {"maxRetries": 2, "maxRetrySeconds": 300}}}
...
def test_get_retry_after_with_max_retry_seconds_exceeded():
    ...
    config = {"client": {"rateLimit": {"maxRetries": 2, "maxRetrySeconds": 60}}}
...
def test_get_retry_after_with_invalid_max_retry_seconds():
    ...
    config = {"client": {"rateLimit": {"maxRetries": 2, "maxRetrySeconds": "invalid"}}}
...
def test_create_request():
    ...
    config = {"client": {"rateLimit": {"maxRetries": 2}, "cloud": "production", "service": "zia"}}
...
def test_create_request_with_none_values():
    ...
    request, error = executor.create_request(method="GET", endpoint="/zia/api/v1/users")
...
def test_create_request_with_legacy_client():
    ...
    request, error = executor.create_request(method="GET", endpoint="/zpa/api/v1/apps")
...
def test_fire_request():
    ...
    config = {"client": {"rateLimit": {"maxRetries": 2}, "cache": {"enabled": False}}}
...
def test_fire_request_with_cache():
    ...
    config = {"client": {"rateLimit": {"maxRetries": 2}, "cache": {"enabled": True}}}
...
def test_fire_request_helper_with_timeout():
    ...
    config = {"client": {"rateLimit": {"maxRetries": 2}, "requestTimeout": 1}}
...
def test_cache_enabled():
    ...
    config = {"client": {"cache": {"enabled": True}, "rateLimit": {"maxRetries": 2}}}
...
def test_cache_disabled():
    ...
    config = {"client": {"cache": {"enabled": False}, "rateLimit": {"maxRetries": 2}}}
...
def test_get_base_url():
    ...
    config = {"client": {"rateLimit": {"maxRetries": 2}, "cloud": "production"}}
...
class TestPartnerIdHeader:
    ...
    def test_partner_id_header_in_create_request(self):
        ...
        mock_oauth._get_access_token.return_value = "mock-token"
        with patch.object(executor, "_oauth", mock_oauth):
            request, error = executor.create_request(method="GET", endpoint="/zia/api/v1/test", headers={}, params={})
...
class TestZIAEditLockRetry:
    ...
    def test_zia_edit_lock_retry_on_409(self):
        ...
        mock_http_client.send_request.side_effect = [(mock_response_409, None), (mock_response_200, None)]
        executor._http_client = mock_http_client
    ...
    def test_zia_edit_lock_exponential_backoff(self):
        ...
        config = {"client": {"rateLimit": {"maxRetries": 3}, "cache": {"enabled": False}}}
    ...
    def test_zia_edit_lock_backoff_capped_at_60_seconds(self):
        ...
        config = {"client": {"rateLimit": {"maxRetries": 5}, "cache": {"enabled": False}}}
