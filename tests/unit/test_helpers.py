...
def test_to_snake_case():
    ...
    assert (
        to_snake_case("dnsResolutionOnTransparentProxyIPv6ExemptApps")
...
def test_to_lower_camel_case():
    ...
    # Complex cases
    assert (
        to_lower_camel_case("enable_ipv6_dns_resolution_on_transparent_proxy") == "enableIPv6DnsResolutionOnTransparentProxy"
    )
    assert (
        to_lower_camel_case("dns_resolution_on_transparent_proxy_ipv6_exempt_apps")
...
def test_convert_keys_to_snake_case():
    ...
    # Simple dictionary
    data = {"clientId": "test_client", "clientSecret": "test_secret", "vanityDomain": "testcompany"}
    result = convert_keys_to_snake_case(data)
    expected = {"client_id": "test_client", "client_secret": "test_secret", "vanity_domain": "testcompany"}
    assert result == expected

    # Nested dictionary
    data = {
        "client": {"clientId": "test_client", "vanityDomain": "testcompany", "cache": {"enabled": True, "defaultTtl": 3600}}
    }
    result = convert_keys_to_snake_case(data)
    expected = {
        "client": {"client_id": "test_client", "vanity_domain": "testcompany", "cache": {"enabled": True, "default_ttl": 3600}}
    }
    assert result == expected

    # List of dictionaries
    data = [{"clientId": "client1", "vanityDomain": "company1"}, {"clientId": "client2", "vanityDomain": "company2"}]
    result = convert_keys_to_snake_case(data)
    expected = [{"client_id": "client1", "vanity_domain": "company1"}, {"client_id": "client2", "vanity_domain": "company2"}]
    assert result == expected
...
def test_convert_keys_to_camel_case():
    ...
    # Simple dictionary
    data = {"client_id": "test_client", "client_secret": "test_secret", "vanity_domain": "testcompany"}
    result = convert_keys_to_camel_case(data)
    expected = {"clientId": "test_client", "clientSecret": "test_secret", "vanityDomain": "testcompany"}
    assert result == expected
    ...
    # List of dictionaries
    data = [{"client_id": "client1", "vanity_domain": "company1"}, {"client_id": "client2", "vanity_domain": "company2"}]
    result = convert_keys_to_camel_case(data)
...
def test_convert_keys_to_camel_case_selective():
    ...
    data = {"client_id": "test_client", "vanity_domain": "testcompany"}
    result = convert_keys_to_camel_case_selective(data, set())
    expected = {"clientId": "test_client", "vanityDomain": "testcompany"}
    assert result == expected
...
def test_convert_keys_to_camel_case_with_feature_permissions():
    ...
    data = {"client_id": "test_client", "featurePermissions": {"read_users": True, "write_users": False, "admin_access": True}}
    result = convert_keys_to_camel_case(data)
    expected = {
...
def test_helper_functions_performance():
    ...
    nested_data = {"level1": {"level2": {"level3": {"level4": {"deep_key": "deep_value"}}}}}
...
def test_helper_functions_roundtrip():
    ...
    test_cases = ["simple_case", "multi_word_case", "with_numbers123", "mixed_Case_String"]
