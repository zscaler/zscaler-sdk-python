...
def test_oauth_client_initialization():
    ...
    config = {"client": {"clientId": "test_client_id", "clientSecret": "test_client_secret", "vanityDomain": "testcompany"}}
...
def test_oauth_client_with_private_key():
    ...
    mock_request_executor = Mock()
    config = {"client": {"clientId": "test_client_id", "privateKey": "test_private_key", "vanityDomain": "testcompany"}}
...
def test_oauth_client_with_sandbox_token():
    ...
    mock_request_executor = Mock()
    config = {"client": {"sandboxToken": "test_sandbox_token", "vanityDomain": "testcompany"}}
...
def test_oauth_client_different_configs():
    ...
    config1 = {"client": {"clientId": "client1", "clientSecret": "secret1", "vanityDomain": "company1"}}

    config2 = {"client": {"clientId": "client2", "clientSecret": "secret2", "vanityDomain": "company2"}}
