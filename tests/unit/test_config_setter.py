...
def test_config_setter_merge_config():
    ...
    # Set up base config
    base_config = {
        "client": {"clientId": "base_client_id", "connectionTimeout": 30, "cache": {"enabled": False, "defaultTtl": 1800}},
        "testing": {"disableHttpsCheck": False},
    }

    # Set up override config
    override_config = {
        "client": {"clientId": "override_client_id", "requestTimeout": 60, "cache": {"enabled": True, "defaultTti": 900}}
    }
...
def test_config_setter_prune_config():
    ...
    config_with_empty = {
        "client": {
            ...
            "emptyField1": "",
            "emptyField2": "",
            "cache": {"enabled": True, "emptyCacheField": ""},
        }
    }
...
def test_config_setter_get_config():
    ...
    test_config = {"client": {"clientId": "test_client_id", "vanityDomain": "testcompany"}}
...
def test_config_setter_setup_logging():
    ...
    config_with_logging = {"client": {"logging": {"enabled": True, "verbose": True}}}
    ...
    config_without_logging = {"client": {"logging": {"enabled": False, "verbose": False}}}
...
def test_config_setter_apply_config_with_nested_values():
    ...
    user_config = {
        "client": {
            "clientId": "test_client_id",
            "cache": {"enabled": True, "defaultTtl": 3600, "defaultTti": 1800},
            "rateLimit": {"maxRetries": 5, "maxRetrySeconds": 300},
