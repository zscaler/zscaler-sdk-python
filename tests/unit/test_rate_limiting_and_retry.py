...
class TestRateLimiter:
    ...
    def setup_method(self):
        ...
        self.rate_limiter = RateLimiter(get_limit=10, post_put_delete_limit=5, get_freq=60, post_put_delete_freq=60)
    ...
    def test_update_limits_with_headers(self):
        ...
        headers = {"X-Ratelimit-Limit-Second": "20", "X-Ratelimit-Reset": "30"}
    ...
    def test_rate_limiter_with_custom_limits(self):
        ...
        custom_limiter = RateLimiter(get_limit=5, post_put_delete_limit=3, get_freq=30, post_put_delete_freq=30)
...
class TestRetryLogic:
    ...
    def test_retry_with_backoff_exponential_backoff(self, mock_sleep):
        ...
        for i, call in enumerate(sleep_calls):
            ...
            ), f"Attempt {i}: delay {delay} not in range [{expected_min}, {expected_max}]"
...
class TestRequestExecutorRateLimiting:
    ...
    def test_get_retry_after_priority_order(self):
        ...
        headers = {"Retry-After": "60", "X-RateLimit-Reset": "1640995200", "RateLimit-Reset": "1640995300"}
        logger = Mock()
    ...
    def test_get_retry_after_max_retry_seconds_limit(self):
        ...
        config_with_limit = {"client": {"rateLimit": {"maxRetries": 3, "remainingThreshold": 2, "maxRetrySeconds": 60}}}
...
class TestRateLimitingIntegration:
    ...
    def test_rate_limiting_configuration_validation(self):
        ...
        custom_config = {"client": {"rateLimit": {"maxRetries": 5, "remainingThreshold": 5, "maxRetrySeconds": 600}}}
