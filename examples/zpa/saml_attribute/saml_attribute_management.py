...
def main():
    ...
    parser.add_argument("-g", "--get", metavar="ATTRIBUTE_ID", help="Get details of a SAML attribute by its ID.")
    parser.add_argument("--list_by_idp_name", metavar="IDP_NAME", help="List all SAML attributes by IdP name.")
    parser.add_argument("--search_name", metavar="ATTRIBUTE_NAME", help="Search a SAML attribute by its name.")
...
def search_attribute_by_name(client, attribute_name):
    ...
    print(json.dumps(filtered_attributes, indent=4) if filtered_attributes else f"No SAML attribute found with name {attribute_name}")
