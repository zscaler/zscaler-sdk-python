...
def main():
    ...
    parser.add_argument("-g", "--get", metavar="IDP_ID", help="Get details of an Identity Provider by ID.")
    parser.add_argument("-n", "--get_by_name", metavar="NAME", help="Get details of Identity Provider by name.")
