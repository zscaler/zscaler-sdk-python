...
def main():
    ...
    parser.add_argument("-g", "--get", metavar="SEGMENT_ID", help="Get details of an application segment by ID")
    parser.add_argument("-d", "--delete", metavar="SEGMENT_ID", help="Delete an application segment by ID")
    ...
    parser.add_argument("--domain_names", nargs='+', help="List of domain names or IP addresses for the application segment")
    parser.add_argument("--segment_group_id", help="The unique identifier for the segment group this application segment belongs to")
    parser.add_argument("--server_group_ids", nargs='+', help="The list of server group IDs that belong to this application segment")
    parser.add_argument("--tcp_port_ranges", nargs='+', help="List of TCP port ranges, e.g., '80,80' '443,443'")
    parser.add_argument("--udp_port_ranges", nargs='+', help="List of UDP port ranges, e.g., '1000,1000' '2000,2000'")
    ...
    if args.list:
        ...
        app_segment = client.app_segments.add_segment(name=name, domain_names=domain_names, segment_group_id=segment_group_id, server_group_ids=server_group_ids, tcp_port_ranges=tcp_port_ranges, udp_port_ranges=udp_port_ranges)
        ...
        update_fields = {"name": "Updated App Segment", "description": "Updated description"}
