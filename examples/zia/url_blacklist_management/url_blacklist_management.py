...
def main():
    ...
    parser.add_argument('action', choices=['get', 'add', 'remove', 'replace', 'erase'], help="Action to perform")
    parser.add_argument('-u', '--urls', help="Comma-separated list of URLs (for add, remove, and replace actions)", default="")
