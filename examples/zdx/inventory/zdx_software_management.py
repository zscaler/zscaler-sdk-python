...
def display_softwares(softwares, max_entries=None):
    ...
    table = PrettyTable(['Software Key', 'Software Name', 'Vendor', 'Software Group', 'Install Type', 'User Total', 'Device Total'])
    if max_entries:
...
def display_software_keys(software_keys, max_entries=None):
    ...
    table = PrettyTable(['Software Key', 'Software Name', 'Version', 'Software Group', 'OS', 'Vendor', 'User ID', 'Device ID', 'Hostname', 'Username', 'Install Date'])
    if max_entries:
