...
def main():
    ...
    with ZscalerClient(config) as client:
        ...
        entries, response, error = client.zins.shadow_it.get_apps(start_time=start_time, end_time=end_time, limit=args.limit)
        ...
        summary, response, error = client.zins.shadow_it.get_shadow_it_summary(start_time=start_time, end_time=end_time)
