...
def main():
    ...
    with ZscalerClient(config) as client:
        ...
        entries, response, error = client.zins.web_traffic.get_traffic_by_location(
        ...
        entries, response, error = client.zins.web_traffic.get_no_grouping(
            start_time=start_time, end_time=end_time, traffic_unit="TRANSACTIONS", limit=args.limit
        )
        ...
        entries, response, error = client.zins.web_traffic.get_protocols(
            start_time=start_time, end_time=end_time, traffic_unit="TRANSACTIONS", limit=args.limit
        )
        ...
        entries, response, error = client.zins.web_traffic.get_threat_super_categories(
            start_time=start_time, end_time=end_time, traffic_unit="TRANSACTIONS", limit=args.limit
        )
        ...
        entries, response, error = client.zins.web_traffic.get_threat_class(
            start_time=start_time, end_time=end_time, traffic_unit="TRANSACTIONS", limit=args.limit
        )
