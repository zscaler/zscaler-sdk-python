...
from zscaler.zid.models.api_client import APIClients
from zscaler.zid.models.api_client import APIClientRecords
from zscaler.zid.models.api_client import APIClientSecrets
...
class APIClientAPI(APIClient):
    ...
    def list_api_clients(self, query_params: Optional[dict] = None) -> APIResult[APIClients]:
        ...
        Examples:
            ...
            >>> client_list, response, error = client.zid.api_client.list_api_clients():
            ... if error:
            ...
            >>> client_list, response, error = client.zid.api_client.list_api_clients(query_params={'limit': 10}):
            ... if error:
            ...     print(f"Error listing clients: {error}")
            ...     return
            ... for client in client_list.records:
    ...
    def get_api_client(self, client_id: str) -> APIResult[dict]:
        ...
        Examples:
            ...
            >>> fetched_client, _, error = client.zid.api_client.get_api_client(
                '1254654')
            >>> if error:
    ...
    def add_api_client(self, **kwargs) -> APIResult[dict]:
        ...
        Examples:
            ...
            >>> add_api_client, _, error = client.zid.api_client.add_api_client(
            ...     name="API_Client01",
    ...
    def update_api_client(self, client_id: str, **kwargs) -> APIResult[dict]:
        ...
        Examples:
            ...
            >>> update_client, _, error = client.zid.api_client.update_api_client(
            ...     client_id='1524566'
            ...     name="API_Client01",
            ...     description="API_Client01",
            ...     status=True",
    ...
    def delete_api_client(self, client_id: str) -> APIResult[dict]:
        ...
        Examples:
            ...
            >>> _, _, error = client.zid.api_client.delete_api_client('73459')
            >>> if error:
    ...
    def get_api_client_secret(self, client_id: str) -> APIResult[dict]:
        ...
        Examples:
            ...
            >>> fetched_client, _, error = client.zid.api_client.get_api_client_secret(
                '1254654')
            >>> if error:
    ...
    def add_api_client_secret(self, client_id: str, **kwargs) -> APIResult[dict]:
        ...
        This secret can be used for authentication with ZIdentity.
         ...
         Examples:
             ...
             >>> added_client_secret, _, error = client.zid.api_client.add_api_client_secret(
    ...
    def delete_api_client_secret(self, client_id: str, secret_id: str) -> APIResult[dict]:
        ...
        Examples:
            ...
            >>> _, _, error = client.zid.api_client.delete_api_client_secret(
            ...     client_id='your_client_id',
