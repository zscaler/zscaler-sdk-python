...
from zscaler.zid.models.groups import Groups
from zscaler.zid.models.groups import GroupRecord
...
class GroupsAPI(APIClient):
    ...
    def list_groups(self, query_params: Optional[dict] = None) -> APIResult[Groups]:
        ...
        Examples:
            ...
            >>> group_list, response, error = client.zid.groups.list_groups():
            ... if error:
            ...
            >>> group_list, response, error = client.zid.groups.list_groups(query_params={'limit': 10}):
            ... if error:
            ...     print(f"Error listing groups: {error}")
            ...     return
            ... for resource in group_list.records:
    ...
    def get_group(self, group_id: int) -> APIResult[dict]:
        ...
        Examples:
            ...
            >>> fetched_group, _, error = client.zid.groups.get_group(
                '1254654')
            >>> if error:
    ...
    def add_group(self, **kwargs) -> APIResult[dict]:
        ...
        Examples:
            ...
            >>> added_group, _, error = client.zid.groups.add_group(
            ...     name="My Test Group",
            ...     id="group123",
            ...     source="SCIM",
    ...
    def update_group(self, group_id: str, **kwargs) -> APIResult[dict]:
        ...
        Examples:
            ...
            >>> updated_group, _, error = client.zid.groups.update_group(
    ...
    def delete_group(self, group_id: str) -> APIResult[dict]:
        ...
        Examples:
            ...
            >>> _, _, error = client.zid.groups.delete_group('73459')
            >>> if error:
    ...
    def list_group_users_details(self, group_id: str, query_params: Optional[dict] = None) -> APIResult[Groups]:
        ...
        Examples:
            ...
            >>> users_list, response, error = client.zid.groups.list_group_users_details():
            ... if error:
    ...
    def add_user_to_group(self, group_id: str, user_id: str, **kwargs) -> APIResult[dict]:
        ...
        Examples:
            ...
            >>> add_user_to_group, _, error = client.zid.groups.add_user_to_group(
    ...
    def add_users_to_group(self, group_id: str, **kwargs) -> APIResult[dict]:
        ...
        Examples:
            ...
            >>> add_users_to_group, _, error = client.zid.groups.add_users_to_group(
            ...     group_id='ia3b1ad9hg66g',
    ...
    def replace_users_groups(self, group_id: str, **kwargs) -> APIResult[dict]:
        ...
        Examples:
            ...
            >>> replace_users, _, error = client.zid.groups.replace_users_groups(
            ...     group_id='ia3b1ad9hg66g',
    ...
    def remove_user_from_group(self, group_id: str, user_id: str) -> APIResult[dict]:
        ...
        Examples:
            ...
            >>> _, _, error = client.zid.groups.remove_user_from_group(
            ...     group_id='ia3b1ad9hg66g',
