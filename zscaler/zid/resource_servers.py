...
from zscaler.zid.models.resource_servers import ResourceServers
from zscaler.zid.models.resource_servers import ResourceServersRecord
...
class ResourceServersAPI(APIClient):
    ...
    def list_resource_servers(self, query_params: Optional[dict] = None) -> APIResult[ResourceServers]:
        ...
        Examples:
            ...
            >>> resource_list, response, error = client.zid.resource_servers.list_resource_servers():
            ... if error:
            ...
            >>> resource_list, response, error = client.zid.resource_servers.list_resource_servers(query_params={'limit': 10}):
            ... if error:
            ...     print(f"Error listing resource servers: {error}")
            ...     return
            ... for resource in resource_list.records:
    ...
    def get_resource_server(self, resource_id: str) -> APIResult[dict]:
        ...
        Examples:
            ...
            >>> fetched_resource, _, error = client.zid.resource_servers.get_resource_server(
                '1254654')
            >>> if error:
