...
from zscaler.zid.models.users import Users
from zscaler.zid.models.users import UserRecord
...
class UsersAPI(APIClient):
    ...
    def list_users(self, query_params: Optional[dict] = None) -> APIResult[Users]:
        ...
        Examples:
            ...
            >>> user_list, response, error = client.zid.users.list_users():
            ... if error:
            ...
            >>> user_list, response, error = client.zid.users.list_users(query_params={'limit': 10}):
            ... if error:
            ...     print(f"Error listing users: {error}")
            ...     return
            ... for user in user_list.records:
    ...
    def get_user(self, user_id: str) -> APIResult[dict]:
        ...
        Examples:
            ...
            >>> fetched_user, _, error = client.zid.users.get_user(
                'ihlmch6ikg7m1')
            >>> if error:
    ...
    def add_user(self, **kwargs) -> APIResult[dict]:
        ...
        Examples:
            ...
            >>> added_user, _, error = client.zid.users.add_user(
    ...
    def delete_user(self, user_id: str) -> APIResult[dict]:
        ...
        Examples:
            ...
            >>> _, _, error = client.zid.users.delete_user(user_id='73459')
            >>> if error:
