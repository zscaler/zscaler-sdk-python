...
from zscaler.zid.models.user_entitlement import Entitlement, Entitlements
from zscaler.zid.models.user_entitlement import Service
...
class EntitlementAPI(APIClient):
    ...
    def get_admin_entitlement(self, user_id: str) -> APIResult[dict]:
        ...
        Examples:
            ...
            >>> fetched_entitlements, _, error = client.zid.user_entitlement.get_admin_entitlement(
                'ihlmch6ikg7m1')
            >>> if error:
    ...
    def get_service_entitlement(self, user_id: str) -> APIResult[dict]:
        ...
        Examples:
            ...
            >>> fetched_entitlement, _, error = client.zid.users.get_service_entitlement(
                'ihlmch6ikg7m1')
            >>> if error:
            ...     print(f"Error fetching Entitlement for User by ID: {error}")
            ...     return
