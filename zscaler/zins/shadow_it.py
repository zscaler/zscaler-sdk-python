...
from zscaler.zins.models.inputs import ShadowITAppsFilterBy, ShadowITAppsOrderBy
...
class ShadowItAPI(APIClient):
    ...
    _zins_base_endpoint = "/zins/graphql"
    ...
    def get_apps(
        ...
        Examples:
            >>> entries, _, err = client.zins.shadow_it.get_apps(
            ...
            >>>
            >>> # With filtering
            >>> from zscaler.zins.models.inputs import ShadowITAppsFilterBy, StringFilter
        ...
        http_method = "POST"
        api_url = format_url(self._zins_base_endpoint)
    ...
    def get_shadow_it_summary(
        ...
        Examples:
            >>> summary, _, err = client.zins.shadow_it.get_shadow_it_summary(
            ...     start_time=start_time,
            ...     end_time=end_time
            ... )
