...
from zscaler.zins.models.inputs import FirewallEntriesFilterBy, FirewallEntryOrderBy
...
class FirewallAPI(APIClient):
    ...
    def get_traffic_by_action(
        ...
        Examples:
            >>> entries, _, err = client.zins.firewall.get_traffic_by_action(
    ...
    def get_traffic_by_location(
        ...
        Examples:
            ...
            ... )
            >>> entries, _, err = client.zins.firewall.get_traffic_by_location(
            ...     start_time=start_time,
            ...     end_time=end_time,
            ...     limit=10,
            ...     filter_by=filter_by
