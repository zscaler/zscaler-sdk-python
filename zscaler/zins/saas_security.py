...
from zscaler.zins.models.inputs import CasbEntriesFilterBy, CasbEntryOrderBy
...
class SaasSecurityAPI(APIClient):
    ...
    def get_casb_app_report(
        ...
        Examples:
            >>> entries, _, err = client.zins.saas_security.get_casb_app_report(
            ...
            >>>
            >>> # With filtering
            >>> from zscaler.zins.models.inputs import CasbEntriesFilterBy, StringFilter
