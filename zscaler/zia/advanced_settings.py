...
class AdvancedSettingsAPI(APIClient):
    ...
    def update_advanced_settings(self, settings: AdvancedSettings) -> tuple:
        """
            ...
            settings (:obj:`AdvancedSettings`): 
                ...
                Supported attributes:
                    ...
                    **DNS and Traffic Control:**
                    - **enable_dns_resolution_on_transparent_proxy (bool)**: Enables DNS optimization for Z-Tunnel 2.0 traffic.
                    - **enable_ipv6_dns_resolution_on_transparent_proxy (bool)**: Enables DNS optimization for IPv6 traffic.
                    - **enable_ipv6_dns_optimization_on_all_transparent_proxy (bool)**: Enables DNS optimization for all IPv6 traffic.
                    - **enable_evaluate_policy_on_global_ssl_bypass (bool)**: Enables policy evaluation for global SSL bypass traffic.
                    ...
                    **Session and Security Settings:**
                    - **enable_office365 (bool)**: Enables Microsoft Office 365 One-Click configuration.
                    - **log_internal_ip (bool)**: Logs internal IP addresses from X-Forwarded-For headers.
                    - **enforce_surrogate_ip_for_windows_app (bool)**: Enforces Surrogate IP authentication for Windows apps.
                    - **track_http_tunnel_on_http_ports (bool)**: Tracks tunneled HTTP traffic on port 80.
                    - **block_http_tunnel_on_non_http_ports (bool)**: Blocks HTTP traffic on non-HTTP/HTTPS ports.
                    - **block_domain_fronting_on_host_header (bool)**: Blocks HTTP transactions with FQDN mismatches.
                    ...
                    - **cascade_url_filtering (bool)**: Applies URL filtering policies even when Cloud App Control allows traffic.
                    - **enable_policy_for_unauthenticated_traffic (bool)**: Enables policy enforcement for unauthenticated traffic.
                    - **block_non_compliant_http_request_on_http_ports (bool)**: 
                      Blocks non-compliant HTTP traffic on standard HTTP/HTTPS ports.
                    - **enable_admin_rank_access (bool)**: Enables admin rank-based access control in policies.
                    - **ui_session_timeout (int)**: Session timeout for ZIA Admin Portal login in seconds.

                    **Advanced Security Features:**
                    - **http2_nonbrowser_traffic_enabled (bool)**: Enables HTTP/2 for non-browser traffic.
                    - **ecs_for_all_enabled (bool)**: Enables ECS option for all DNS queries.
                    - **dynamic_user_risk_enabled (bool)**: Tracks risky user behavior in real time.
                    - **block_connect_host_sni_mismatch (bool)**: Blocks requests where CONNECT host and SNI mismatch.
                    - **prefer_sni_over_conn_host (bool)**: Prefers SNI over CONNECT host for DNS resolution.
                    - **sipa_xff_header_enabled (bool)**: Inserts XFF headers in ZIA-to-ZPA traffic.
                    - **block_non_http_on_http_port_enabled (bool)**: Blocks non-HTTP traffic on standard HTTP/HTTPS ports.
