...
class AdminUserAPI(APIEndpoint):
    def add_user(self, name: str, login_name: str, email: str, password: str, **kwargs) -> Box:
        ...
        Examples:
            ...
            Add an admin user with the minimum required params:
                >>> admin_user = zia.admin_user.add_user(
                ...    name="Jim Bob",
            ...
            Add an auditor user:
                >>> auditor_user = zia.admin_user.add_user(
                ...    name="Head Bob",
    ...
    def list_users(self, **kwargs) -> BoxList:
        ...
        Examples:
            >>> users = zia.admin_user.list_users(search='login_name')
    ...
    def get_user(self, user_id: str) -> Box:
        ...
        Examples:
            >>> print(zia.admin_user.get_user('987321202'))
    ...
    def update_user(self, user_id: str, **kwargs) -> dict:
        ...
        Examples:
            ...
            Update the email address for an admin user:
                >>> user = zia.admin_user.update_user('99695301',
