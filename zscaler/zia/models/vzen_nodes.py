...
class VZenNodes(ZscalerObject):
    """
    A class for VZenNodes objects.
    """

    def __init__(self, config=None):
        """
        Initialize the VZenNodes model based on API response.
        ...
        if config:
            ...
            self.on_demand_support_tunnel_enabled = None
            self.establish_support_tunnel_enabled = None
            self.load_balancer_ip_address = None
            self.deployment_mode = None
            self.cluster_name = None
            self.vzen_sku_type = None
    ...
    def request_format(self):
        ...
        current_obj_format = {
            "id": self.id,
            "zgatewayId": self.zgateway_id,
            "name": self.name,
            "status": self.status,
            "inProduction": self.in_production,
            "ipAddress": self.ip_address,
            "subnetMask": self.subnet_mask,
            "defaultGateway": self.default_gateway,
            "type": self.type,
            "ipSecEnabled": self.ip_sec_enabled,
            "onDemandSupportTunnelEnabled": self.on_demand_support_tunnel_enabled,
            "establishSupportTunnelEnabled": self.establish_support_tunnel_enabled,
