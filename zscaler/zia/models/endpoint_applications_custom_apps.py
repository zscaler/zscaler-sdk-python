...
class EndpointApplicationsCustomApps(ZscalerObject):
    """
    A class for EndpointApplicationsCustomApps objects.
    """

    def __init__(self, config: Optional[Dict[str, Any]] = None) -> None:
        """
        Initialize the EndpointApplicationsCustomApps model based on API response.
