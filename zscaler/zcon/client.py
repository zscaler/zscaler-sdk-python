...
class ZCONClient:
    ...
    def get_paginated_data(
        ...
        """
        Send a GET request to the ZCON API to fetch all pages of a resources.
        Parameters:
        - path (str): API endpoint path.
    ...
    def put(self, path: str, json=None, params=None):
        """
        Send a PUT request to the ZCON API.
        Parameters:
        - path (str): API endpoint path.
        - json (str): the request body.
        - params (dict): the query params
    ...
    def patch(self, path: str, json=None, params=None):
        """
        Send a PATCH request to the ZCON API.
        Parameters:
        - path (str): API endpoint path.
        - json (str): the request body.
        - params (dict): the query params
    ...
    def post(self, path: str, json=None, params=None):
        """
        Send a POST request to the ZCON API.
        Parameters:
        - path (str): API endpoint path.
        - json (str): the request body.
        - params (dict): the query params
    ...
    def delete(self, path: str, json=None, params=None):
        """
        Send a DELETE request to the ZCON API.
        Parameters:
        - path (str): API endpoint path.
        - json (str): the request body.
        - params (dict): the query params
