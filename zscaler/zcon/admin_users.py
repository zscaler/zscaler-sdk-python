...
from zscaler.zcon.models.admin_users import AdminUsers
...
class AdminUsersAPI(APIClient):
    ...
    def list_admins(self, query_params=None) -> tuple:
        ...
        api_url = format_url(
            f"""
            {self._zcon_base_endpoint}/adminUsers
            """
        )
    ...
    def get_admin(self, admin_id: str) -> tuple:
        ...
        api_url = format_url(f"""
            {self._zcon_base_endpoint}/adminUsers/{admin_id}
            """
        )
