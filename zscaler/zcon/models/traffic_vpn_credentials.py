...
from zscaler.zcon.models import location_management as location_management
...
class TrafficVPNCredentials(ZscalerObject):
    ...
    def __init__(self, config=None):
        ...
        if config:
            ...
            self.xauth_password = config["xauthPassword"]\
                if "xauthPassword" in config else None
