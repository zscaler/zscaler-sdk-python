...
class StepUpAuthLevel(ZscalerObject):
    """
    A class for StepUpAuthLevel objects.
    """

    def __init__(self, config=None):
        """
        Initialize the StepUpAuthLevel model based on API response.
        ...
        if config:
            ...
            self.iam_auth_level_id = None
            self.id = None
            self.modified_by = None
            self.modified_time = None
            self.name = None
            self.parent_iam_auth_level_id = None
    ...
    def request_format(self):
        ...
        current_obj_format = {
            ...
            "iamAuthLevelId": self.iam_auth_level_id,
            "id": self.id,
