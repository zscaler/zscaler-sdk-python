...
class ServiceEdgeSchedule(ZscalerObject):
    def __init__(self, config=None):
        """
        Initialize the ServiceEdgeSchedule model based on API response.

        Args:
            config (dict): A dictionary representing the Service Edge Schedule configuration.
        """
