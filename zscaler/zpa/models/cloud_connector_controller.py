...
class CloudConnectorController(ZscalerObject):
    """
    A class for CloudConnectorController objects.
    """

    def __init__(self, config=None):
        """
        Initialize the CloudConnectorController model based on API response.
        ...
        if config:
            ...
            self.id = None
            self.ip_acl = ZscalerCollection.form_list([], str)
