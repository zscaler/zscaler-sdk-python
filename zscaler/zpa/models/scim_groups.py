...
class SCIMGroup(ZscalerObject):
    def __init__(self, config=None):
        """
        Initialize the SCIMGroup model based on API response.

        Args:
            config (dict): A dictionary representing the SCIM Group configuration.
        """
