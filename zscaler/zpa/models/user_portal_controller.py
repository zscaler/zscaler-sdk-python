...
class UserPortalController(ZscalerObject):
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None) -> None:
        ...
        if config:
            ...
            self.getc_name = config["getcName"] if "getcName" in config else None
            self.id = config["id"] if "id" in config else None
            self.image_data = config["imageData"] if "imageData" in config else None
            ...
            self.managed_by_zs = config["managedByZs"] if "managedByZs" in config else None
        else:
