...
class CustomerDRToolVersionAPI(APIClient):
    """
    A client object for the Customer DR Tool Version resource.
    """
    ...
    def list_latest_dr_tool_versions(self, query_params: Optional[dict] = None) -> APIResult[dict]:
        """
        ...
        Args:
            query_params {dict}: Map of query parameters for the request.
                ...
                ``[query_params.page_num]`` {str}: Specifies the page number.
