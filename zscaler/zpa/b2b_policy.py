...
class B2bPolicyAPI(APIClient):
    ...
    def get_policy_set_rules_policy_type_globalpolicy_guest(self, query_params=None) -> APIResult:
        """
        ...
        api_url = format_url(f"""
            ...
            /policySet/rules/policyType/GLOBAL_POLICY/guest
        """)
