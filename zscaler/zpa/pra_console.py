...
class PRAConsoleAPI(APIClient):
    ...
    def list_consoles(self, query_params: Optional[dict] = None) -> APIResult[List[PrivilegedRemoteAccessConsole]]:
        """
    ...
    def update_console(self, console_id: str, **kwargs) -> APIResult[dict]:
        ...
        if response is None or not response.get_body():
            return (PrivilegedRemoteAccessConsole({"id": console_id}), response, None)
