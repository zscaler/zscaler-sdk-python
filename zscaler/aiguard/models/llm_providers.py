...
class LlmProviders(ZscalerObject):
    """
    A class for LlmProviders objects.
    """

    def __init__(self, config: Optional[Dict[str, Any]] = None) -> None:
        """
        Initialize the LlmProviders model based on API response.
        ...
        if config:
            ...
            self.public = config["public"] if "public" in config else None
        else:
            self.id = None
            self.name = None
            self.type = None
