...
#         # BEGIN ADDED BLOCK
#         # Special handling for ZPA pagination:
#         #   - All endpoints except /emergencyAccess/users require "pagesize" in lowercase
#         #   - The /emergencyAccess/users endpoint specifically needs "pageSize" in camelCase
#         if self._service_type == "ZPA":
#             if self._url and "/emergencyAccess/users" in self._url:
#                 # For the emergencyAccess/users endpoint, rename pagesize -> pageSize
#                 if "pagesize" in self._params:
#                     self._params["pageSize"] = self._params.pop("pagesize")
#             else:
#                 # For everything else in ZPA, rename pageSize -> pagesize
#                 if "pageSize" in self._params:
#                     self._params["pagesize"] = self._params.pop("pageSize")
#         # END ADDED BLOCK
