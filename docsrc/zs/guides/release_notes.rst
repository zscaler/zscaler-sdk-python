...
* (`#275 <https://github.com/zscaler/zscaler-sdk-python/pull/275>`_) - Fixed ZCC `download_devices` method to support `octet-stream` header
* (`#275 <https://github.com/zscaler/zscaler-sdk-python/pull/275>`_) - Fixed ZCC `devices` model attributes and attribute edge cases.
* (`#275 <https://github.com/zscaler/zscaler-sdk-python/pull/275>`_) - Fixed missing link for resource `cloud_apps` in both `legacy` and `OneAPI` client
* (`#275 <https://github.com/zscaler/zscaler-sdk-python/pull/275>`_) - `cloud_apps` resource has been renamed to `shadow_it_report` for consistency.
