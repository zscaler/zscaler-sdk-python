...
[PR #279](https://github.com/zscaler/zscaler-sdk-python/pull/279) - Added the following new ZPA API Endpoints:
...
[PR #279](https://github.com/zscaler/zscaler-sdk-python/pull/279)hon/pull/278) - Added the following new ZPA API Endpoints:
...
* [PR #279](https://github.com/zscaler/zscaler-sdk-python/pull/279) - Fixed `username` parameter in the ZCC `devices` model for the correct non-standard `snake_case` vs `cameCase` format.
* [PR #279](https://github.com/zscaler/zscaler-sdk-python/pull/279) - Added missing `user_risk_score_levels` and `source_ip_groups` attributes to `dlp_web_rules`
